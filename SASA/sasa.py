...
parser.add_argument('-r', '--residue', action='store_true', required=False, default=True, help='Calculate atom-wise or residue-wise SASA. Passing the flag changes to residues.')
...
sasa = mdtraj.shrake_rupley(traj=traj, mode='residue' if arg.residue else 'atom')
